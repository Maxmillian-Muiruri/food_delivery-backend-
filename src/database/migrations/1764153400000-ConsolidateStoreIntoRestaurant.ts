...
export class ConsolidateStoreIntoRestaurant1764153400000
  implements MigrationInterface
{
  name = 'ConsolidateStoreIntoRestaurant1764153400000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Update transfer recipient_type from 'store' to 'restaurant' (in case there are any existing records)
    await queryRunner.query(
      `UPDATE "transfer" SET "recipient_type" = 'restaurant' WHERE "recipient_type" = 'store'`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    // Recreate store table
    await queryRunner.query(
      `CREATE TABLE "store" ("store_id" int NOT NULL IDENTITY(1,1), "owner_id" int NOT NULL, "name" varchar(255) NOT NULL, "description" varchar(255) NOT NULL, "contact_info" varchar(255) NOT NULL, "image_url" varchar(255), "rating" decimal(3,2) NOT NULL CONSTRAINT "DF_7f8053a08d9b306d33cd5a92d39" DEFAULT 0, "total_reviews" int NOT NULL CONSTRAINT "DF_71447167b826a60209d4b873cd7" DEFAULT 0, "store_code" varchar(50) NOT NULL, "delivery_fee" int NOT NULL CONSTRAINT "DF_da436e732144656383b329b9829" DEFAULT 0, "is_active" bit NOT NULL CONSTRAINT "DF_972b85ff8596b3627f838aa1972" DEFAULT 1, "is_verified" bit NOT NULL CONSTRAINT "DF_f26c3863817be0589ddcbe2c86e" DEFAULT 0, "account_number" varchar(50), "created_at" datetime2 NOT NULL CONSTRAINT "DF_776aaf868cdb9c168372a2bb1b0" DEFAULT getdate(), "updated_at" datetime2 NOT NULL CONSTRAINT "DF_ce61796e8a8564da8605e8bac19" DEFAULT getdate(), "address_id" int, CONSTRAINT "UQ_8ce7c0371b6fca43a17f523ce44" UNIQUE ("owner_id"), CONSTRAINT "UQ_eaf3d0b9edcf9fe6bc0cdf61f69" UNIQUE ("store_code"), CONSTRAINT "PK_94d7b0f600366ceb5c960069687" PRIMARY KEY ("store_id"))`,
    );

    // Add back store_id to orders table
    await queryRunner.query(`ALTER TABLE "orders" ADD "store_id" int`);

    // Update transfer recipient_type back to 'store'
    await queryRunner.query(
      `UPDATE "transfers" SET "recipient_type" = 'store' WHERE "recipient_type" = 'restaurant'`,
    );

    // Remove store fields from restaurants table
    await queryRunner.query(
      `ALTER TABLE "restaurants" DROP CONSTRAINT "UQ_store_code"`,
    );
    await queryRunner.query(
      `ALTER TABLE "restaurants" DROP COLUMN "business_total_reviews"`,
    );
    await queryRunner.query(
      `ALTER TABLE "restaurants" DROP COLUMN "business_rating"`,
    );
    await queryRunner.query(
      `ALTER TABLE "restaurants" DROP COLUMN "account_number"`,
    );
    await queryRunner.query(
      `ALTER TABLE "restaurants" DROP COLUMN "store_code"`,
    );
  }
}
